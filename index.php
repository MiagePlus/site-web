...
<body>
	...
	<!-- Navigation -->
	<div class="navbar navbar-default navbar-fixed-top top-nav-collapse margin-0 main-background main-border"
		role="navigation">
		<div class="container">
			...
			<nav class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li style="height: 54px;">
						<a class="nav-item main-color forward" href="#presentation"
							id="nav_pres">Pr&eacute;sentation</a>
		...
		<div class="container intro">
			<div class="row margin-bottom-50">
				<div class="col-md-12 text-center">
					...
					<p class="lead">Le traditionnel gala de la MIAGE, tant attendu,<br />aura de nouveau lieu cette
						année.</p>
				</div>
			</div>
				...
				<div>
					...
					<div class="col-md-3 col-sm-6">
						<div>
							...
							<p>Choisissez sagement, elle aura pour mission de vous repr&eacute;senter tout au long de
								l'ann&eacute;e</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-8 col-md-push-4 ">
					...
					<div class="row margin-bottom-30">
						<div class="col-md-6">
							...
							<div class="col-md-12">
								<p class="main-background justified">Depuis plus de 10 ans... In nec elit solliudin,
									elementum, dictum pur quam volutpat suscipit antena.</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="col-xs-10">
							...
							<div class="col-md-12">
								<p class="main-background justified">Des &eacute;tudiants engag&eacute;s... solliudin,
									elementum, dictum pur quam volutpat suscipit antena.</p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-12">
								<p class="main-background justified">Plusieurs langages maitris&eacute;s... solliudin,
									elementum, dictum pur quam volutpat suscipit antena.</p>
							</div>
						</div>
						<div class="col-md-6">
							...
							<div class="col-md-12">
								<p class="main-background justified">Demandez aux clients... In nec elit solliudin,
									elementum, dictum pur quam volutpat suscipit antena.</p>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row ">
							<div class="col-md-12 contact-container">
								...
								<hr class="title-underline" />
								<p id="result_mail">Maecenas luctus nisi in sem fermentum blat. In nec elit solliudin,
									elementum, dictum pur quam volutpat suscipit antena.</p>
								<form name="form_mail" id="form_mail" action="send_mail.php" method="POST">
									<div class="form-group">
										<input type="text" class="form-control" name="user" id="user" placeholder="Nom"
											required />
									</div>
									<div class="form-group">
									...
									<div class="text-center margin-top-30">
										<button type="button" class="btn btn-default" id="submit_mail"
											onclick="send_mail();">ENVOYER&nbsp;&nbsp;&nbsp;<i
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 footer-menu">
					...
					<div>
						<a href="https://www.facebook.com/assomiageplus/" title="Facebook" target="_blank"
							class="social-icon"><i class="fa fa-facebook"></i></a>
						<a href="https://twitter.com/AssoMiagePlus" title="Twitter" target="_blank"
